...
from power_tasks import start_schedules
start_schedules()  # 启动定时任务
...
def dashboard():
    ...
    try:
        ...
        return f"<h1>500</h1><p>dashboard.html render error: {e}</p>", 500
...
def config_page():
    ...
    try:
        ...
        return "<h1>404</h1><p>config.html not found in static/</p>", 404
